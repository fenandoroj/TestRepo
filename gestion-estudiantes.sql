...
--
-- Servidor: localhost
-- Tiempo de generación: 15-12-2021 a las 01:17:16
...
--
CREATE DATABASE IF NOT EXISTS `gestion-estudiantes` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `gestion-estudiantes`;
